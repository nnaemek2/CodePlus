...
@section('panel')
    ...
    <div class="row gy-4 mt-2">
        <div class="col-xxl-3 col-sm-6">
            <x-widget style="7" link="{{ route('admin.sell.items') }}" icon="las la-check-double f-size--56" title="Sales Amount"
            value="{{ showAmount($widget['total_sale_amount']) }}" bg="success" />
        </div><!-- dashboard-w1 end -->
        <div class="col-xxl-3 col-sm-6">
            <x-widget style="7" link="{{ route('admin.report.transaction') }}?remark=seller_fee" icon="la la-percentage f-size--56"
            title="Seller Charge" value="{{ showAmount($widget['total_seller_charge']) }}" bg="warning" />
        </div><!-- dashboard-w1 end -->
        <div class="col-xxl-3 col-sm-6">
    ...
    <div class="row gy-4 mt-2">
        <div class="col-xxl-3 col-sm-6">
         ...
         title="Total Payment"
            value="{{ showAmount($deposit['total_deposit_amount']) }}" bg="success" outline="true" />
        </div><!-- dashboard-w1 end -->
        <div class="col-xxl-3 col-sm-6">
            <x-widget style="6" link="{{ route('admin.deposit.pending') }}" icon="fas fa-spinner"
            title="Pending Payments " value="{{ $deposit['total_deposit_pending'] }}" bg="warning" outline="true" />
        </div><!-- dashboard-w1 end -->
        <div class="col-xxl-3 col-sm-6">
            <x-widget style="6" link="{{ route('admin.deposit.rejected') }}" icon="fas fa-ban"
            title="Rejected Payments" value="{{ $deposit['total_deposit_rejected'] }}" bg="danger" outline="true" />
        </div><!-- dashboard-w1 end -->
        <div class="col-xxl-3 col-sm-6">
            <x-widget style="6" link="{{ route('admin.deposit.list') }}" icon="fas fa-percentage"
            title="Paid Charge" value="{{ showAmount($deposit['total_deposit_charge']) }}" bg="primary" outline="true" />
        </div><!-- dashboard-w1 end -->
    </div><!-- row end-->
