                            ...
                            <div class="payment-system-list is-scrollable gateway-option-list">
                                <label for="account-balance"
                                    ...
                                    <div class="payment-item__info">
                                        ...
                                        <span class="payment-item__name">@lang('Account Balance') ({{ showAmount(auth()->user()->balance) }})</span>
                                    </div>
                                    <div class="payment-item__thumb">
                                        <img class="payment-item__thumb-img"
                                            src="{{ getImage('assets/images/avatar.png') }}"
                                            alt="@lang('payment-thumb')">
                                    </div>
                                    <input class="payment-item__radio gateway-input" id="account-balance" hidden type="radio" name="gateway"
                                    ...
                                    <div class="deposit-info__input">
                                        <div class="deposit-info__input-group input-group">
                                            ...
                                            <input type="text" class="form-control form--control amount" name="amount"
                                                placeholder="@lang('00.00')" value="{{ old('amount', $amount) }}" autocomplete="off" readonly>
                                        </div>
                                    </div>
                                </div>
                                <hr>
                                ...
                                <div class="deposit-info hideInfo">
                                    <div class="deposit-info__title">
                                        <p class="text has-icon">@lang('Processing Charge')
                                            <span data-bs-toggle="tooltip" title="@lang('Processing charge for payment gateways')" class="processing-fee-info"><i
