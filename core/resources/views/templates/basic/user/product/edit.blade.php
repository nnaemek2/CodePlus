        ...
        <div class="container">
            <div class="row">
                <div class="col-xxl-8 col-xl-10 mb-4">
                    <form method="POST" class="upload-product-item-wrapper" enctype="multipart/form-data" action="{{ route('user.product.save', $product->id) }}">
                        @csrf
                        ...
                        <div class="upload-product-item">
                            ...
                            <div class="form-group">
                                ...
                                <select id="itemSupport" class="select form--control form--control--sm select2" data-minimum-results-for-search="-1">
                            ...
                            <div class="license-price-content-wrapper">
                                <div class="license-price-content priceGroup" data-seller_fee="{{ getAmount(gs('personal_buyer_fee')) }}">
                                    ...
                                    <div class="license-price-content__price">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" step="any" name="price" value="{{ getAmount($product->price) }}" class="form-control form--control form--control--sm">
                                        </div>
                                    </div>
                                ...
                                <div class="license-price-content priceGroup" data-seller_fee="{{ getAmount(gs('commercial_buyer_fee')) }}">
                                    ...
                                    <div class="license-price-content__price">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-text">{{ gs('cur_sym') }}</span>
                                            <input type="number" step="any" name="price_cl" value="{{ getAmount($product->price_cl) }}" class="form-control form--control form--control--sm">
                                        </div>
                                    </div>
                                    <span class="license-price-content__operator">+</span>
                                    <div class="license-price-content__price">
                    ...
                    <form action="{{ route('user.product.upload') }}" method="GET" class="upload-product-item-wrapper">
                        <div class="upload-product-item">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="" id="" value="{{ @$product->category->name }}" disabled class="form--control">
                            </div>
                            <div class="form-group">
                                <label class="form--label">@lang('Subcategory')</label>
                                <input type="text" name="" id="" value="{{ @$product->subCategory->name }}" disabled class="form--control">
                            </div>
                        </div>
                    </form>
                </div>
